...
class CustomNuScenesDataset(NuScenesDataset):
    ...
    def get_data_info(self, index):
        ...
        input_dict = dict(
            ...
            # is_last=info['is_last'], # Comment these 2 after assumption test
            # valid_flag=info['valid_flag'] # Comment these 2 after assumption test
        )
        ...
        # Include the ground truth annotations even in test mode for visualization purposes
