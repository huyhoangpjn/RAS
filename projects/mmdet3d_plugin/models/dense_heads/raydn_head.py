# TODO: migrate directly the denoising code into sparsehead
import torch
...
class RayDNHead(AnchorFreeHead):
    ...
    def forward(self, img_metas, **data):
        ...
        outs_dec, outs_cross_attn = self.transformer(tgt, query_pos, feat_flatten, spatial_flatten, level_start_index, temp_memory, 
    ...
    def _get_target_single(self,
        ...
        if sampling_result.num_gts > 0:
            ...
            bbox_weights[pos_inds] = 1.0 if not self.gt_balancing or not self.use_ray_o2m else box_weights_o2o.unsqueeze(-1).repeat(1, 10)
    ...
    def loss_single(self,
        ...
        num_total_pos = loss_cls.new_tensor([num_total_pos]) if (not self.use_ray_o2m or self.gt_balancing) else loss_cls.new_tensor([num_total_o2m_pos])
