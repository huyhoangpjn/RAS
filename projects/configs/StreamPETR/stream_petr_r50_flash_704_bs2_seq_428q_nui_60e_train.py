...
depthnet_config = {'hidden_dim': 256, 'depthnet_dim': 256,'num_depth_bins': 50, 'depth_min': 1e-1, 'depth_max': 60, 'stride': 16}  # 1024 -> stride 16
...
model = dict(
    ...
    img_roi_head=dict(
        ...
        with_depth=False, # Supervise depth
