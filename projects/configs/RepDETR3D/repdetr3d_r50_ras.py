...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        num_query=300, # 300
        memory_len=512, # 512
        topk_proposals=128, # 128
        num_propagated=128, # 128
        with_ego_pos=True,
        ...
        bbox_coder=dict(
            ...
            nms_threshold=0.5,
            # cls_spec_nms = {0: 0.5, 1: 0.4, 2: 0.2, 3: 0.6, 4: 0.2, 5: 0.5, 6: 0.5, 7: 0.5, 8: 0.8, 9: 0.5}, optimal nms threshold
...
optimizer = dict(
    ...
    paramwise_cfg=dict(
        custom_keys={
            'img_backbone': dict(lr_mult=0.1), # 0.1 # set to 0.1 always better when apply 2D pretrained.
        }),
    weight_decay=0.01)
...
checkpoint_config = dict(interval=10*num_iters_per_epoch, max_keep_ckpts=6)
runner = dict(
...
custom_hooks = [
    ...
    dict(type='VisualizeMatchingHook', plot_interval=20000, save_dir='assignment_logs'),
]
# syncBN=True
