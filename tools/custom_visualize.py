...
def lidiar_render(sample_token, data,out_path=None):
    ...
    for content in bbox_anns:
        if content['detection_score'] >= 0.25:
    ...
    for ind, cam in enumerate(cams):
        ...
        if sensor_modality in ['lidar', 'radar']:
            ...
            boxes = [Box(record['translation'], record['size'], Quaternion(record['rotation']),
                     ...
                     pred_data['results'][sample_toekn] if record['detection_score'] >= 0.25]
...
if __name__ == '__main__':
    ...
    # results = mmcv.load('./val/notebooks/pretrained/stream_petr_r50_flash_704_bs2_seq_428q_nui_60e_retrain/Wed_Jul_30_22_20_05_2025/pts_bbox/results_nusc.json')
    # results = mmcv.load('./test/repdetr3d_r50_428q_nui_60e_train_decoupled/Mon_Oct_27_16_52_05_2025/pts_bbox/results_nusc.json')
    #results = results = mmcv.load('./val/notebooks/pretrained/stream_petr_r50_flash_704_bs2_seq_428q_nui_60e_retrain/Wed_Jul_30_22_20_05_2025/pts_bbox/results_nusc.json')
    results = mmcv.load('/home/renault/Hoang/3D_detection/StreamPETR/test/repdetr3d_r50_428q_nui_60e_train/Fri_Oct_24_15_58_44_2025/pts_bbox/results_nusc.json')
    results_o2m = mmcv.load('./test/repdetr3d_r50_428q_nui_60e_train_decoupled/Mon_Oct_27_16_52_05_2025/pts_bbox/results_nusc.json')
    sample_token_list = ['3d2ce1b79d1c45e5b7db4f26f411bb86', 'e1dffaba060040cfab07dec04790fbfa', 'f7d75d25c86941f3aecfed9efea1a3e3', '32d941ca626c458381f13c0c7ab267b8' ]# list(results_o2m['results'].keys())
    for id in range(len(sample_token_list)):
        render_sample_data(sample_token_list[id], pred_data=results_o2m, out_path=f'./result_vis/r50_o2m_paper/{sample_token_list[id]}')
        render_sample_data(sample_token_list[id], pred_data=results, out_path=f'./result_vis/r50_other/{sample_token_list[id]}')